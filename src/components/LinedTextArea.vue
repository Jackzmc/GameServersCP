<!-- credit to https://github.com/Shenmin-Z/lined-textarea/blob/master/src/LinedTextarea.vue -->
<template>
...
export default {
    ...
    methods: {
        ...
        syncScroll() {
            this.$refs.lines.style.transform = `translateY(-${this.scrolledLength.toString()}px)`;
        },
    }
};
</script>
